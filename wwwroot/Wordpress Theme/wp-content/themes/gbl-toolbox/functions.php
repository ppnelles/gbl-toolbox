...
add_action('wp_head', 'gbl_canonical');
...
function get_meta_title() {
    ...
    /* if (is_singular('chants')) :
    	echo "Parole et traduction du chant";
    elseif (is_singular('masques')) :
    	echo "Description du masque traditionnel";
    else :
   	 bloginfo( 'name' );
	endif; */
...
function get_meta_description() {
		...
		echo "Défaut texte de description pour google";
